...
<@layout>
<form class="layui-form" action="/exIdDict/save" method="post" id="newItemForm">
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="input-required">*</span>id串定义：</label>
        <div class="layui-input-block">
            <input type="text" name="idStr" class="layui-input" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="input-required">*</span>id序号：</label>
        <div class="layui-input-block">
            <input type="text" name="idSeqno" class="layui-input" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="input-required">*</span>id描述信息：</label>
        <div class="layui-input-block">
            <input type="text" name="idDesc" class="layui-input" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
