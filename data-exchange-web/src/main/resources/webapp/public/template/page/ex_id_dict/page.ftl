    ...
    <script>
        layui.use(['laydate', 'table', 'layer', 'global'], function () {
            ...
            var dataTable = table.render({
                elem: '#dataTable',
                url: '/exIdDict/pageData', //数据接口
                where: {},
                page: true, //开启分页
                cols: [[ //表头
                    {type: 'checkbox'},
                    {field: 'seqNo', title: '序号'},
                    {field: 'idStr', title: 'id串定义'},
                    {field: 'idSeqno', title: 'id序号'},
                    {field: 'idDesc', title: 'id描述信息'},
                    {
