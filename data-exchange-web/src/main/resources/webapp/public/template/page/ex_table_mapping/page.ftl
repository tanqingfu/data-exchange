        ...
        <div class="layui-card-body">
            <form class="layui-form" id="queryForm">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: auto">源库表名</label>
                    <div class="layui-input-inline">
                        <input type="text" name="sourceSyncName" class="layui-input">
                    </div>
        ...
        layui.use(['laydate', 'table', 'layer', 'global'], function () {
            ...
            var dataTable = table.render({
                ...
                cols: [[ //表头
                    ...
                    {field: 'sourceDb', title: '源库描述'},
                    {field: 'sourceUser', title: '源库用户名'},
                    {field: 'sourceTable', title: '源库表名'},
                    {field: 'destDb', title: '目标库描述'},
                    {field: 'destUser', title: '目标库用户名'},
                    {field: 'destTable', title: '目标表名'},
