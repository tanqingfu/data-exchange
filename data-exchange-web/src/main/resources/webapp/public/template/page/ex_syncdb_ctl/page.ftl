    ...
    <script>
        layui.use(['laydate', 'table', 'layer', 'global'], function () {
            ...
            var dataTable = table.render({
                elem: '#dataTable',
                url: '/exSyncdbCtl/pageData', //数据接口
                where: {},
                page: true, //开启分页
                cols: [[ //表头
                    {type: 'checkbox'},
                    {field: 'gatherId', title: '采集id'},
                    {field: 'sourceDbid', title: '库源id'},
                    {field: 'syncSeqno', title: '同步序号'},
                    {field: 'syncTime', title: '同步时间'},
                    {
