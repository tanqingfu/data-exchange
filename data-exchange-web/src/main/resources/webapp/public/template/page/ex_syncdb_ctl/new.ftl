...
<@layout>
<form class="layui-form" action="/exSyncdbCtl/save" method="post" id="newItemForm">
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="input-required">*</span>采集id：</label>
        <div class="layui-input-block">
            <input type="text" name="gatherId" class="layui-input" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="input-required">*</span>库源id：</label>
        <div class="layui-input-block">
            <input type="text" name="sourceDbid" class="layui-input" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span class="input-required">*</span>同步时间：</label>
        <div class="layui-input-block">
            <input type="text" name="syncTime" class="layui-input" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
