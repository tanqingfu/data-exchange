...
<script>
    layui.use(['laydate', 'table', 'layer', 'global', 'laypage', 'layer'], function () {
        ...
        var dataTable = table.render({
            ...
            cols: [[ //表头
                {field: 'gatherDesc', minWidth: '100', align: 'center', title: '交换节点名称'},
                {field: 'serviceIp', minWidth: '100', align: 'center', title: '服务器IP'},
                {field: 'serviceDesc', minWidth: '100', align: 'center', title: '服务器描述'},
                {field: 'gatherPath', minWidth: '100', align: 'center', title: '交换节点路径'},
                {field: 'sshPort', minWidth: '100', align: 'center', title: 'ssh端口'},
                {field: 'sshUser', minWidth: '100', align: 'center', title: 'ssh用户名'},
            ]]
        });
