    ...
    <script>
        layui.use(['laydate', 'table', 'layer', 'global'], function () {
            ...
            var dataTable = table.render({
                elem: '#dataTable',
                url: '/exTablePrimarykey/pageData', //数据接口
                where: {},
                page: true, //开启分页
                cols: [[ //表头
                    {type: 'checkbox'},
                    {field: 'dbid', title: '库id'},
                    {field: 'tableid', title: '表id'},
                    {field: 'fieldNum', title: '字段个数'},
                    {field: 'prmField1', title: '字段1'},
                    {field: 'prmField2', title: '字段2'},
                    {field: 'prmField3', title: '字段3'},
                    {field: 'prmField4', title: '字段4'},
                    {field: 'prmField5', title: '字段5'},
                    {field: 'prmField6', title: '字段6'},
                    {field: 'prmField7', title: '字段7'},
                    {field: 'prmField8', title: '字段8'},
                    {field: 'prmField9', title: '字段9'},
                    {field: 'prmField10', title: '字段10'},
                    {field: 'id', title: '主键'},
                    {
            ...
            table.on('tool(dataTable)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') { //详情
                    $.ajax({
                        url: '/exTablePrimarykey/detailPage',
                        data: {id: data.id},
                        async: false,
                    ...
                    $.ajax({
                        url: '/exTablePrimarykey/updatePage',
                        data: {id: data.id},
                        async: false,
                        success: function (data, status, xhr) {
                            layer.open({
            ...
            $('#delItems').click(function () {
                ...
                layer.confirm('确认批量删除？', function (index) {
                    $.ajax({
                        url: '/exTablePrimarykey/deleteBatch',
