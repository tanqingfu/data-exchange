        ...
        <div class="content-input clearfix">
            <div class="layui-form-item ml" style="clear:none">
                <div class="layui-inline">
                    <label class="layui-form-label" style="width: 115px">任务选择</label>
                    <div class="layui-input-block">
                        <select name="jobId" id="jobId" style="width:207px;height:38px;margin-top:-38px;border:1px solid #eee;border-radius:5px;padding-left:10px">
            ...
            <div class="button">
                <button type="button" class="layui-btn layui-btn-primary btn-look" onclick="window.reloadTable()" id="queryForm" >查询</button>
            </div>
        </div>
        <div class="table">
