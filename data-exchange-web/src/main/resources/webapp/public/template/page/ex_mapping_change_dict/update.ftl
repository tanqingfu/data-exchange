...
<@layout>
    <form class="layui-form" action="/exMappingChangeDict/update" method="post" id="updateItemForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="modifyTime" id="modifyTime_update" class="layui-input" lay-verify="required" autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label"><span class="input-required">*</span>有效标志：</label>
            <div class="layui-input-block">
                <input type="text" name="flag" value="${param.flag!''}" class="layui-input" lay-verify="required">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
